            ...
            <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
                ...
                <div class="col">
                    <div class="card shadow-sm">
                        ...
                        <div class="card-body">
                            <a class="mt-1 mb-1" style="font-size: 0.75rem; text-decoration: none;" href="{{route('itemCategory', ['id' => $news['id_category']])}}">{{ $news['category']}}</a>
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <a href="{{route('itemNews', ['id' => $news['id']])}}" type="button" class="btn btn-outline-primary btn-sm px-4">Читать</a>
                            </div>
                        </div>
                    </div>
                </div>
